        ...
        <li>
            <div class="slide-table">
                ...
                <table class="form-table">
					...
					<tr>
                        <td><?php _e( 'Read More Url', 'dokan' ); ?></td>
                        <td>
    ...
    function save_meta( $post_id, $post ) {
        ...
        foreach ($posted['slide_type'] as $key => $value) {
            $data = array(
                ...
                'slide_more_text' => trim( $posted['slide_more_text'][$key] ),
    ...
    public function get_slider( $slider_id ) {
        ...
        if( $slides ) {
            ...
            foreach ($slides as $slide) {
                ...
                $link_content = sprintf('<a href="%s" class="button" target="%s"><i class="fa fa-play"></i> %s</a>', esc_url( $slide_link ), $slide_link_open, __( $slide_more_text, 'wedevs' ) );
