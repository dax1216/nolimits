...
class Dokan_Admin_Settings {
    ...
    function admin_menu() {
        ...
        $dashboard = add_menu_page( __( 'Nolimits Creation', 'dokan' ), __( 'Nolimits ', 'dokan' ), $capability, 'dokan', array($this, 'dashboard'), 'dashicons-vault', $menu_position );
        add_submenu_page( 'dokan', __( 'Nolimits Dashboard', 'dokan' ), __( 'Dashboard', 'dokan' ), $capability, 'dokan', array($this, 'dashboard') );
