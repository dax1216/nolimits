<?php
$size = 'caring-detail-slider-image';
$properties_images = rwmb_meta( 'NO_LIMIT_caring_images', 'type=plupload_image&size='.$size, $post->ID );
        ...
        <div class="flexslider">
            <ul class="slides">
                ...
                foreach( $properties_images as $prop_image_id=>$prop_image_meta ){
                    ...
                    $slider_thumb = wp_get_attachment_image_src($prop_image_id,'caring-detail-slider-thumb');
